...
public class EverestIpojoTestCommon extends BaseTest {
    ...
    /**
     * The everest namespace.
     */
    public static final String EVEREST = "org.ow2.chameleon.everest";

    /**
     * The name of the "Bar" factories.
     */
    public static final String BAR = EVEREST + ".ipojo.test.b1.BarProviderImpl";

    /**
     * The class name of the "Bar" 2.0.0 factory.
     */
    public static final String BAR_2 = EVEREST + ".ipojo.test.b2.BarProviderImpl";
    ...
    protected Option[] getCustomOptions() {
        ...
        return options(
                ...
                generateTestBundle(TEST_BUNDLE_SYMBOLIC_NAME, EVEREST + ".ipojo.test.b1", "metadata.1.xml", null),
                generateTestBundle(TEST_BUNDLE_2_SYMBOLIC_NAME, EVEREST + ".ipojo.test.b2", "metadata.2.xml", null),
                // everest bundles
                mavenBundle(EVEREST, "everest-core").versionAsInProject(),
                mavenBundle(EVEREST, "everest-ipojo").versionAsInProject(),
                mavenBundle(EVEREST, "everest-osgi").versionAsInProject(),
